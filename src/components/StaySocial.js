...
function StaySocial() {
  ...
  return (
    <div>
      {screenSize <= 500 ?
        (<div>
          <div className="stay-social-mobile-view-container">
            <div className="stay-social-mobile-view-name">Stay  Social</div>
            <div className="stay-social-mobile-view-subtext">FOLLOW @NOURA-RETREATS</div>
            <div class="conteudo-mobile-view">
            <div class="carrousel-mobile-view">
